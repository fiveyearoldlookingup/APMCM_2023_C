...
# 加载数据
data = pd.read_excel('E:/科研程序/代码/vscode/亚太杯/亚太杯/第一题/DATAGlobal.xlsx')
...
# 提取关键列
sales_volume = data['Global traditional energy vehicle sales']
infrastructure = data['Plug-in sales']
...
# 将平稳化后的数据导出到Excel
combined_data_stationary.to_excel('E:/科研程序/代码/vscode/亚太杯/亚太杯/第一题/StationaryData.xlsx')
